...
title-slide-attributes:
  data-background-image: 'https://images.unsplash.com/photo-1639431682289-72b9ebb75895' 
...
::: {.column width="70%"}
:::{.small}
Hi!  I'm Christian Testa 👋  I'm now a 2nd year PhD student in 
Biostatistics (started in 2023).  From 2017-2023, I was a statistical analyst here at the
Harvard T.H. Chan School of Public Health.

My recent research has focused on causal inference, health disparities, spatio-temporal statistics, and infectious disease epidemiology.  

Some of the projects I've worked on with Jarvis and Nancy Krieger have focused on epigenetic
aging, multiple types of discrimination, COVID-19, and spatiotemporal
methods, especially disease mapping models. More recently I've been focused on longitudinal modified
treatment policies under interference. <br><br>
:::
...
<center>
<img src="https://github.com/ID529/lectures/blob/main/graphics/hodu_pics/christmas_hodu.jpeg?raw=true" alt='hodu, a white fluffy dog, in a santa hat with a tie' height='550px'>
</center>
:::
...
# course philosophy {background-image="https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/harvard-green.jpg?raw=true" background-color='black' background-opacity='40%'}
...
<center><img height='200px' src="https://github.com/ID529/lectures2024/blob/master/graphics/gifs/dog-with-paper.gif?raw=true" alt='gif of a golden retriever with the newspaper'></center>
...
<center>
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/memes/shocked_pikachu_any_analysis.png?raw=true"
...
:::{.fragment}
<center>
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/memes/its-fine-meme.jpg?raw=true" height='280px' alt='a little dog surrounded by lush plants saying this is fine'>
</center>
:::
...
<center>
:::{.fragment}
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/hodu_pics/constructive_feedback.jpeg?raw=true" alt='one puppy barking at another who is standing on a platform' height='400px'>
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/hodu_pics/hodu_and_sabre.jpeg?raw=true" alt='one puppy barking at another who is standing on a platform' height='400px'>
:::
</center>
...
:::{.smaller}
:::{.incremental}
Generally, we support you using the Harvard AI Sandbox to help you learn 
to program and experiment with new ideas. However, AI/LLM software often makes 
mistakes, so you should vet all of its responses before believing anything. 

:::{.fragment}
Running large models comes at costs in terms of electricity used to 
train and query them, rare earth minerals mined to go into GPUs, etc., so realize 
you should be mindful of the resources you're consuming and not just turning to 
AI to solve every problem for you. 
:::

:::{.fragment}
We will prioritize teaching you other, more conventional ways to get help 
in your journey to learn R. 
:::
:::
:::
...
<img src="https://www.mwra.com/sites/default/files/styles/wysiwyg_image/public/2025-01/MWRAData20250109-NSGraph.JPG?itok=8rRCS5nJ" alt="biobot wastewater data from the Boston area">
...
# time for a live demo 🤞 {background-color='black'  background-opacity='40%' background-image="https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/yen-vu.jpg?raw=true"}

## what are some of the principles that the live demo employed?  {background-color='black'  background-opacity='40%' background-image="https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/corey-bruce.jpg?raw=true"}
