...
title-slide-attributes: 
  data-background-image: "https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/manuel-will.jpg?raw=true"
...
# let's start with RStudio {background-color='black' background-image="https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/manuel-will.jpg?raw=true" background-opacity='70%'}
...
## some particularly important keyboard shortcuts

:::{.small}

  * Use `Cmd+Enter` (MacOS) or `Ctrl+Enter` (Windows/Linux) to 
  run a line or highlighted code. 
    <img src="images/initial_workflow/run.png">
  * `Cmd+Shift+C`/`Ctrl+Shift+C` comments or uncomments selected lines. 
  * `F1` pulls up help pages for the selected function. 
  * `Cmd+Shift+A`/`Ctrl+Shift+A` reformats/reindents the selected code.
  * `Alt -` inserts an `<-` into your code
  * `Cmd+Shift+M`/`Ctrl+Shift+M` inserts a pipe `|>`
...
# basics of R {background-color="black" background-image="https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/manuel-will.jpg?raw=true" background-opacity='40%'}
...
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/hodu_pics/IMG_1646.jpeg?raw=true" width='300px' alt='Hodu body length'>
:::

:::{.fragment .absolute top='10%' left='0%'}
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/hodu_pics/IMG_1648.jpeg?raw=true" width='300px' alt="Hodu's ear width">
:::

:::{.fragment .absolute top='10%' left='0%'}
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/hodu_pics/IMG_1653.jpeg?raw=true" width='300px' alt="Hodu's nose">
:::

:::{.fragment .absolute top='10%' left='0%'}
<img src="https://github.com/ID529/lectures2024/blob/master/graphics/hodu_pics/IMG_7002.jpg?raw=true" height='400px' alt="Hodu and three friends">
:::
:::
...
# key takeaways {background-image='https://github.com/ID529/lectures2024/blob/master/graphics/transition_slides/manuel-will.jpg?raw=true' background-color='black' background-opacity='40%'}
